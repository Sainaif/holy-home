...
func main() {
	...
	billService := services.NewBillService(repos.Bills, repos.Consumptions, repos.Allocations, allocationService, repos.Payments, repos.Users, repos.Groups, notificationService)
